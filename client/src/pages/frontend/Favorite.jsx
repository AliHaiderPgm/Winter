    ...
    return (
        <div className="w-75 mx-auto p-4 favorite">
            <div className='d-flex justify-content-between mb-3'>
                ...
                {
                    products.length > 0 && <Button className={isEdit ? 'btn-filled' : 'btn-outline'} size='large' onClick={handleEditButtonClick}>
                        {isEdit ? 'Done' : 'Edit'}
                    </Button>
                }
            </div>
            {
                products.length === 0 ? <p className='text-center'>Items added to your Favorites will be saved here.</p>
                    :
